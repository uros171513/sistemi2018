...
public class MedicalRecord {
	...
	public MedicalRecord(Disease disease, ArrayList<Symptom> symptoms) {
...
//	public boolean containsAnalgetics(ArrayList<Medicine> analgetics) {
//		System.err.println("Prosledio sam "+analgetics.size()+ " analgetika");
//		System.err.println("Ima "+this.medicine.size()+" lekova");
//		return true;
//
//	}
